          ...
          if(API){
            ...
            if(value !== "" && errorCode === 0){
                ...
                switch(parameter){
                    ...
                    case "cmi.core.lesson_status": scorm.data.completionStatus = value; break;
                    case "cmi.completion_status" : scorm.data.completionStatus = value; break;
                    
                    case "cmi.core.exit": scorm.data.exitStatus = value; break;
...
pipwerks.UTILS.trace = function(msg){
     ...
     alert("alerts" + pipwerks.debug.isActive);
